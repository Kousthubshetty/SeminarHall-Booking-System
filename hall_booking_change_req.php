	...
	<div  class="col-lg-4 col-md-4">
	  Total Strength<span class="errmsg"  id="errtotal_strength"></span>
		...
		<div class="slidecontainer">
  			<input type="range" name="total_strength" min="1" max="<?php echo $rshalldet['max_capacity']; ?>" class="slider slider-green" id="myRange1">
  			<p>Value: <b><span id="demo1" style="color: #5cb85c;"></span></b></p>
		</div>
	</div>
</div>
<div class="row">
	<div  class="col-lg-4 col-md-4"><br>
		Booking Date
		<input type="date" class="form-control" name="booking_date" id="booking_date1" value="<?php echo $bookingdate; ?>" readonly>
	</div>
			
	<div  class="col-lg-4 col-md-4"><br>
		Start Time
		<input type="time" class="form-control" name="booking_st_time" id="booking_st_time1"  value="<?php echo $starttime; ?>" readonly>
	</div>

	<div  class="col-lg-4 col-md-4"><br>
		End Time
		<input type="time" class="form-control" name="booking_end_time" id="booking_end_time1" value="<?php echo $endtime; ?>"  readonly >
	</div>		
</div>
<div class="row">
