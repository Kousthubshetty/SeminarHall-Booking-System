...
if(isset($_POST['btnsubmit']))
{
	...
	$sqllogin1= "SELECT * FROM admin WHERE emailid='$_POST[emailid]' AND password='$pwd' AND status='Inactive'";
    $qsqllogin1 = mysqli_query($con,$sqllogin1);


    $sqllogin= "SELECT * FROM admin WHERE emailid='$_POST[emailid]' AND password='$pwd' AND status='Active'";
			...
			<div class="wrap-login100">
				<form class="login100-form p-l-55 p-r-55 p-t-178" method="post" onsubmit="return validateform()">
					...
					<div class="text-right p-t-13 p-b-23">
						<a href="adminforgotpassword.php" class="txt2">
							 Forgot Password?
						</a>
					</div>
